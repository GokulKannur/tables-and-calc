...
export const calculatorList: CalculatorListItem[] = [
  ...
  },
  {
    ...
    emoji: '🧪',
    details: {
      whatIs: 'A scientific calculator is a tool designed to solve problems in science, engineering, and mathematics. This version is powered by the robust GeoGebra engine.',
      formula: 'This calculator supports a wide range of functions, including trigonometric, logarithmic, matrices, and calculus operations.',
      usage: {
  ...
  },
  {
    ...
    emoji: '📐',
    details: {
      whatIs: 'A trigonometry calculator helps solve for the unknown sides and angles of a right-angled triangle. By providing any two known values, you can find the remaining properties of the triangle.',
      formula: 'Calculations are based on the Pythagorean theorem (a² + b² = c²) and trigonometric functions like sine (SOH), cosine (CAH), and tangent (TOA).'
    }
  },
  // ADD THESE NEW FINANCIAL CALCULATORS
  {
    ...
    emoji: '🏠',
    details: {
      whatIs: 'A mortgage calculator helps estimate the monthly payments for a home loan, based on the loan amount, interest rate, and term.',
  ...
  },
  {
    ...
    emoji: '📈',
    details: {
      whatIs: 'Compound interest is the interest on a loan or deposit calculated based on both the initial principal and the accumulated interest from previous periods.',
  ...
  },
  {
    ...
    emoji: '💰',
    details: {
        whatIs: 'Simple interest is a quick method of calculating the interest charge on a loan. It is determined by multiplying the daily interest rate by the principal by the number of days that elapse between payments.',
        formula: 'I = P × R × T',
    }
  },
  {
    ...
    emoji: '🏷️',
    details: {
        whatIs: 'A discount calculator determines the final price of an item after a percentage-based discount is applied.',
        formula: 'Final Price = Original Price × (1 - Discount / 100)',
    }
  },
  // ✨ ADD THESE NEW ELECTRICITY CALCULATORS
  {
    ...
    emoji: '💡',
    details: {
      whatIs: 'An electricity bill calculator helps estimate the cost of running electrical appliances over a specific period. It uses the power consumption of a device, hours of use, and the cost per kilowatt-hour (kWh).',
  ...
  },
  {
    ...
    emoji: '🔌',
    details: {
      whatIs: 'An energy consumption calculator determines the amount of electrical energy an appliance uses in kilowatt-hours (kWh) over time.',
  ...
  },
  {
    ...
    emoji: '💲',
    details: {
      whatIs: 'An energy cost calculator provides a detailed breakdown of the cost to run an appliance per day, month, and year.',
