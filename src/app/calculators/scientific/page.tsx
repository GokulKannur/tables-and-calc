  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pb-12">
      ...
      <div className="bg-white p-4 sm:p-6 border rounded-lg shadow-sm">
        ...
        {/* Conditionally render the correct calculator component */}
        {calculatorData.slug === 'percentage-calculator' && <PercentageCalculator />}
        {calculatorData.slug === 'bmi-calculator' && <BmiCalculator />}
        {calculatorData.slug === 'gpa-calculator' && <GpaCalculator />}
        {calculatorData.slug === 'number-converter' && <NumberConverter />}
        {calculatorData.slug === 'scientific-calculator' && <GeoGebraCalculator />}
      </div>
      ...
      {/* ✨ NEW: Dynamically render the "How to Use" instructions if they exist in the data */}
